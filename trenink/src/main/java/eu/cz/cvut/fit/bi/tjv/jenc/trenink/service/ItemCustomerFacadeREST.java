...
import eu.cz.cvut.fit.bi.tjv.jenc.trenink.controller.ItemCustomerController;
...
@Stateless
@Path("itemcustomer")
public class ItemCustomerFacadeREST {

    @EJB
    private ItemCustomerController controller;
    ...
    public ItemCustomer find(@PathParam("id") Long id) {
