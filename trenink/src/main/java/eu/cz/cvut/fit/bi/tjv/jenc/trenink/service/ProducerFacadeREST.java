...
import eu.cz.cvut.fit.bi.tjv.jenc.trenink.controller.ProducerController;
...
@Stateless
@Path("producer")
public class ProducerFacadeREST  {
    ...
    public Producer find(@PathParam("id") Long id) {
    ...
    @Path("findC/{s}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Collection<Producer> findConstrain(@PathParam("s") String x, @PathParam("s") String s) {
