...
public class ItemCustomer implements Serializable {
    ...
    public ItemCustomer(Long itemCustomerId) {
    ...
    public void setItemCustomerId(Long itemCustomerId) {
        this.itemCustomerId = itemCustomerId;
    }
    ...
    public String toString() {
        return "eu.cz.cvut.fit.bi.tjv.jenc.trenink.ItemCustomer[ itemCustomerId=" + itemCustomerId + " ]";
    }
