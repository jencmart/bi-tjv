 ...
 */
package eu.cz.fit.bitjv.cv8.carservice.entities.service;

import eu.cz.fit.bitjv.cv8.carservice.entities.Driver;
 ...
 */
@Stateless
@Path("eu.cz.fit.bitjv.cv8.carservice.entities.driver")
public class DriverFacadeREST extends AbstractFacade<Driver> {

    @PersistenceContext(unitName = "eu.cz.fit.bitjv.cv8_CarService_war_1.0-SNAPSHOTPU")
