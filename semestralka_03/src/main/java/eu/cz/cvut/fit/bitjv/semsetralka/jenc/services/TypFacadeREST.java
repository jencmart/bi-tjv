...
import eu.cz.cvut.fit.bitjv.semsetralka.jenc.controller.TypCntroller;
...
@Stateless
@Path("typ")
public class TypFacadeREST {

    @EJB
    private TypCntroller controller;
    ...
    public Typ find(@PathParam("id") Long id) {
    ...
    @Path("findC/{s}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Collection<Typ> findConstrain(@PathParam("s") String s) {
