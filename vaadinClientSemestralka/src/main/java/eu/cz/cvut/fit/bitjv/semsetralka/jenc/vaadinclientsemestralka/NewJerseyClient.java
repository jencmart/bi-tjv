 ...
 */
package eu.cz.cvut.fit.bitjv.semsetralka.jenc.vaadinclientsemestralka;
...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/semestralka_03/webresources";

    public NewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entity.prispevek");
    }
