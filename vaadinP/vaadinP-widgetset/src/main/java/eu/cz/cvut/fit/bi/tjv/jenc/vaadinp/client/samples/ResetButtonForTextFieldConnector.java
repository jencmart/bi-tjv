package eu.cz.cvut.fit.bi.tjv.jenc.vaadinp.client.samples;
...
import eu.cz.cvut.fit.bi.tjv.jenc.vaadinp.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@eu.cz.cvut.fit.bi.tjv.jenc.vaadinp.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
