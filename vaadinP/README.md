...
- vaadinP-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadinP-ui: main application module, development time
- vaadinP-production: module that produces a production mode WAR for deployment
